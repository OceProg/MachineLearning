...
object tp_reg_tele {
  ...
  def main(args: Array[String]): Unit = {
    ...
    window.canvas.setTitle("Regression linéaire sur echantillon \n NON filtré")
    ...
    //plot
    val window2 = smile.plot.plot(data_filtered, 'S')
    window2.canvas.setTitle("Regression linéaire sur echantillon \n filtré")
    window2.canvas.setAxisLabel(0, "appel_audience_FILTERED")
    window2.canvas.setAxisLabel(1, "jt_audience_FILTERED")
    window2.canvas.line(coordpred_flitered, Line.Style.SOLID, Color.GREEN).setLegend('p')
    window2.canvas.line(coordres_filtered, Line.Style.DASH, Color.BLACK).setLegend('r')
  }
